...
% Letters
%*********
% Shorthand commands for (uppercase) calligraphic letters:
...
% Declare shorthand commands for (lowercase and uppercase) boldface letters:
...
\newcommand{\zmbf}{\mathbf{z}}
% Declare shorthand commands for (lowercase and uppercase) overlined letters:
...
\newcommand{\zbar}{\oline{z}}
% Declare shorthand commands for (lowercase and uppercase) tilded letters:
...
\newcommand{\ztilde}{\tilde{z}}
% Declare shorthand commands for (lowercase and uppercase) hatted letters:
...
% Shorthand commands for begin/end statements:
...
% Shorthand commands for begin/end combination statements:
...
\def\indicator#1{{\mathrm{1\mkern-4.6mu l\!}\left[{#1}\right]}}
\newcommand{\VCdim}{{d_{\Hcal}}}
\newcounter{figtemp}
\def\nmb{n_{\rm mb}}
\author{Xu Zhenkai}
...
% TODO: Need to add DemoContent.tex file.
\input{}
% **************
% Bibliography
% **************
\bibliographystyle{plain}
% If use bib file(demo.bib -> demo)

% TODO: Need to add bib or bbl file.
\bibliography{}

% If use bbl file
% \input{Optimization.bbl}
